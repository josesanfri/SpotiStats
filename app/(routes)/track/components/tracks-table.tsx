                    ...
                    <TableBody>
                        ...
                        <TableRow key={tracks.id}>
                            <TableCell className="flex items-center gap-2">
                                ...
                                <img loading="lazy" src={tracks.album.images[0].url} alt={tracks.name} className="w-16 h-16" />
                            </TableCell>
                            <TableCell className="text-xs sm:text-base">{tracks.name}</TableCell>
                            <TableCell className="text-xs sm:text-base">{tracks.album.artists[0].name}</TableCell>
                        </TableRow>
                        ))}
                    </TableBody>
                </Table>
