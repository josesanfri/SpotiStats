...
export function useGetArtistsShortTerm() {
    const [dataArtistsShortTerm, setDataArtistsShortTerm] = useState<ArtistType | null>(null);
    ...
    useEffect(() => {
        ...
        const fetchArtistData = async () => {
            try {
                ...
                const response = await axios.get("https://api.spotify.com/v1/me/top/artists?time_range=short_term&limit=20&offset=0", headers);
                const res = response.data;

                setDataArtistsShortTerm(res);
                setLoading(false);
            } catch (error) {
    ...
    return { dataArtistsShortTerm, loadingShort, error };
}
